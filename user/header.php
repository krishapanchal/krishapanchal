...
function active($current_page){
    $url_array = explode('/', $SERVER['REQUEST_URL']);
    $url=end($url_array);
    if($current_page==$url){
        echo 'active';
    }
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <a href="menu" class="nav-item nav-link <?php active('menu') ?>">Menu & Pricing</a>
                <a href="team" class="nav-item nav-link <?php active('team') ?>">Master Chefs</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                    <div class="dropdown-menu m-0">
                        <a href="service" class="dropdown-item <?php active('service') ?>">Our Service</a>
